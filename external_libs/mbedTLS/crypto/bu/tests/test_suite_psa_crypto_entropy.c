 ...
 *
 * Test file      : ./test_suite_psa_crypto_entropy.c
 *
 ...
 *      Test suite file     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_entropy.function
 *      Test suite data     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_entropy.data
 *
 *
...
#line 2 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_entropy.function"
#include <stdint.h>
...
#line 41 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_entropy.function"
...
#line 85 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_entropy.function"
...
void test_run_entropy_inject_with_crypto_init_wrapper( void ** params )
{
    ...
    test_run_entropy_inject_with_crypto_init(  );
}
...
int get_expression( int32_t exp_id, int32_t * out_value )
{
    ...
    switch( exp_id )
    {
        ...
        case 0:
            {
                *out_value = MBEDTLS_PSA_INJECT_ENTROPY_MIN_SIZE;
            }
            break;
        case 1:
            {
        ...
        case 3:
            {
                *out_value = MBEDTLS_ENTROPY_MAX_SEED_SIZE;
            }
            break;
        case 4:
            {
                *out_value = MBEDTLS_ENTROPY_MAX_SEED_SIZE+1;
            }
            break;
        case 5:
            {
...
#if defined(MBEDTLS_PSA_INJECT_ENTROPY)
    test_validate_entropy_seed_injection_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */
...
#if defined(MBEDTLS_PSA_INJECT_ENTROPY)
    test_run_entropy_inject_with_crypto_init_wrapper,
#else
    NULL,
#endif
...
int execute_tests( int argc , const char ** argv )
{
    ...
    const char *default_filename = "./test_suite_psa_crypto_entropy.datax";
