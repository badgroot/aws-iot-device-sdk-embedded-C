 ...
 *      Test suite file     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_persistent_key.function
 *      Test suite data     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_persistent_key.data
 *
 *
...
#line 2 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_persistent_key.function"
#include <stdint.h>
#include "psa/crypto.h"
...
#line 27 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_persistent_key.function"
...
void test_format_storage_data_check_wrapper( void ** params )
{
    ...
    test_format_storage_data_check( &data0, &data2, *( (int *) params[4] ), *( (int *) params[5] ), *( (int *) params[6] ), *( (int *) params[7] ) );
}
#line 53 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_persistent_key.function"
...
void test_parse_storage_data_check_wrapper( void ** params )
{
    ...
    test_parse_storage_data_check( &data0, &data2, *( (int *) params[4] ), *( (int *) params[5] ), *( (int *) params[6] ), *( (int *) params[7] ), *( (int *) params[8] ) );
}
#line 88 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_persistent_key.function"
void test_save_large_persistent_key( int data_too_large, int expected_status )
{
...
void test_save_large_persistent_key_wrapper( void ** params )
{
    ...
    test_save_large_persistent_key( *( (int *) params[0] ), *( (int *) params[1] ) );
}
#line 117 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_persistent_key.function"
void test_persistent_key_destroy( int key_id_arg, int should_store,
...
void test_persistent_key_destroy_wrapper( void ** params )
{
    ...
    test_persistent_key_destroy( *( (int *) params[0] ), *( (int *) params[1] ), *( (int *) params[2] ), &data3, *( (int *) params[5] ), &data6 );
}
#line 165 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_persistent_key.function"
void test_persistent_key_import( int key_id_arg, int type_arg, data_t *data,
                            int expected_status )
{
...
void test_persistent_key_import_wrapper( void ** params )
{
    ...
    test_persistent_key_import( *( (int *) params[0] ), *( (int *) params[1] ), &data2, *( (int *) params[4] ) );
}
#line 196 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_persistent_key.function"
...
void test_import_export_persistent_key_wrapper( void ** params )
{
    ...
    test_import_export_persistent_key( &data0, *( (int *) params[2] ), *( (int *) params[3] ), *( (int *) params[4] ) );
}
...
int get_expression( int32_t exp_id, int32_t * out_value )
{
    ...
    switch( exp_id )
    {
        ...
        case 5:
            {
                *out_value = PSA_ERROR_STORAGE_FAILURE;
            }
            break;
        case 6:
            {
                *out_value = PSA_ERROR_INSUFFICIENT_STORAGE;
            }
            break;
        case 7:
            {
