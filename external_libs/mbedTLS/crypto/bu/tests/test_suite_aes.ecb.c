 ...
 *      Test suite data     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_aes.ecb.data
 *
 *
...
int execute_tests( int argc , const char ** argv )
{
    ...
    const char *default_filename = "./test_suite_aes.ecb.datax";
