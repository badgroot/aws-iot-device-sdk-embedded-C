 ...
 *      Test suite file     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function
 *      Test suite data     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.data
 *
 *
...
#line 2 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 154 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 198 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 234 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 261 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 280 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 310 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 329 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 340 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 359 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 384 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
void test_key_selection_algorithm( int alg_arg, int classification_flags )
{
    psa_algorithm_t alg = alg_arg;
...
void test_key_selection_algorithm_wrapper( void ** params )
{

    test_key_selection_algorithm( *( (int *) params[0] ), *( (int *) params[1] ) );
}
#line 409 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
void test_key_agreement_algorithm_wrapper( void ** params )
{
    ...
    test_key_agreement_algorithm( *( (int *) params[0] ), *( (int *) params[1] ), *( (int *) params[2] ) );
}
#line 436 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
...
#line 467 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_psa_crypto_metadata.function"
void test_ecc_key_types( int curve_arg, int curve_bits_arg )
{
...
void test_ecc_key_types_wrapper( void ** params )
{

    test_ecc_key_types( *( (int *) params[0] ), *( (int *) params[1] ) );
}
...
int get_expression( int32_t exp_id, int32_t * out_value )
{
    ...
    switch( exp_id )
    {
        ...
        case 80:
            {
                *out_value = PSA_ALG_FFDH( PSA_ALG_HKDF( PSA_ALG_SHA_256 ) );
            }
            break;
        case 81:
            {
        ...
        case 93:
            {
                *out_value = KEY_TYPE_IS_KEYPAIR | KEY_TYPE_IS_RSA;
            }
            break;
        case 94:
            {
        ...
        case 96:
            {
                *out_value = PSA_KEY_TYPE_DSA_KEYPAIR;
            }
            break;
        case 97:
            {
                *out_value = KEY_TYPE_IS_KEYPAIR | KEY_TYPE_IS_DSA;
            }
            break;
        case 98:
            {
                *out_value = PSA_ECC_CURVE_SECT163K1;
            }
            break;
        case 99:
            {
                *out_value = PSA_ECC_CURVE_SECT163R1;
            }
            break;
        case 100:
            {
                *out_value = PSA_ECC_CURVE_SECT163R2;
            }
            break;
        case 101:
            {
                *out_value = PSA_ECC_CURVE_SECT193R1;
            }
            break;
        case 102:
            {
                *out_value = PSA_ECC_CURVE_SECT193R2;
            }
            break;
        case 103:
            {
                *out_value = PSA_ECC_CURVE_SECT233K1;
            }
            break;
        case 104:
            {
                *out_value = PSA_ECC_CURVE_SECT233R1;
            }
            break;
        case 105:
            {
                *out_value = PSA_ECC_CURVE_SECT239K1;
            }
            break;
        case 106:
            {
                *out_value = PSA_ECC_CURVE_SECT283K1;
            }
            break;
        case 107:
            {
                *out_value = PSA_ECC_CURVE_SECT283R1;
            }
            break;
        case 108:
            {
                *out_value = PSA_ECC_CURVE_SECT409K1;
            }
            break;
        case 109:
            {
                *out_value = PSA_ECC_CURVE_SECT409R1;
            }
            break;
        case 110:
            {
                *out_value = PSA_ECC_CURVE_SECT571K1;
            }
            break;
        case 111:
            {
                *out_value = PSA_ECC_CURVE_SECT571R1;
            }
            break;
        case 112:
            {
                *out_value = PSA_ECC_CURVE_SECP160K1;
            }
            break;
        case 113:
            {
                *out_value = PSA_ECC_CURVE_SECP160R1;
            }
            break;
        case 114:
            {
                *out_value = PSA_ECC_CURVE_SECP160R2;
            }
            break;
        case 115:
            {
                *out_value = PSA_ECC_CURVE_SECP192K1;
            }
            break;
        case 116:
            {
                *out_value = PSA_ECC_CURVE_SECP192R1;
            }
            break;
        case 117:
            {
                *out_value = PSA_ECC_CURVE_SECP224K1;
            }
            break;
        case 118:
            {
                *out_value = PSA_ECC_CURVE_SECP224R1;
            }
            break;
        case 119:
            {
                *out_value = PSA_ECC_CURVE_SECP256K1;
            }
            break;
        case 120:
            {
                *out_value = PSA_ECC_CURVE_SECP256R1;
            }
            break;
        case 121:
            {
                *out_value = PSA_ECC_CURVE_SECP384R1;
            }
            break;
        case 122:
            {
                *out_value = PSA_ECC_CURVE_SECP521R1;
            }
            break;
        case 123:
            {
                *out_value = PSA_ECC_CURVE_BRAINPOOL_P256R1;
            }
            break;
        case 124:
            {
                *out_value = PSA_ECC_CURVE_BRAINPOOL_P384R1;
            }
            break;
        case 125:
            {
                *out_value = PSA_ECC_CURVE_BRAINPOOL_P512R1;
            }
            break;
        case 126:
            {
                *out_value = PSA_ECC_CURVE_CURVE25519;
            }
            break;
        case 127:
            {
                *out_value = PSA_ECC_CURVE_CURVE448;
            }
            break;
#endif
...
int dep_check( int dep_id )
{
    ...
    switch( dep_id )
    {
        ...
        case 32:
            {
#if defined(MBEDTLS_ECP_DP_SECT163K1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 33:
            {
#if defined(MBEDTLS_ECP_DP_SECT163R1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 34:
            {
#if defined(MBEDTLS_ECP_DP_SECT163R2_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 35:
            {
#if defined(MBEDTLS_ECP_DP_SECT193R1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 36:
            {
#if defined(MBEDTLS_ECP_DP_SECT193R2_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 37:
            {
#if defined(MBEDTLS_ECP_DP_SECT233K1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 38:
            {
#if defined(MBEDTLS_ECP_DP_SECT233R1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 39:
            {
#if defined(MBEDTLS_ECP_DP_SECT239K1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 40:
            {
#if defined(MBEDTLS_ECP_DP_SECT283K1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 41:
            {
#if defined(MBEDTLS_ECP_DP_SECT283R1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 42:
            {
#if defined(MBEDTLS_ECP_DP_SECT409K1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 43:
            {
#if defined(MBEDTLS_ECP_DP_SECT409R1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 44:
            {
#if defined(MBEDTLS_ECP_DP_SECT571K1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 45:
            {
#if defined(MBEDTLS_ECP_DP_SECT571R1_ENABLED)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
...
#if defined(MBEDTLS_PSA_CRYPTO_C)
    test_key_selection_algorithm_wrapper,
#else
    NULL,
#endif
/* Function Id: 10 */
