 ...
 *      Test suite file     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_asn1write.function
 *      Test suite data     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_asn1write.data
 *
 *
...
#line 2 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_asn1write.function"
#include "mbedtls/asn1write.h"

#define GUARD_LEN 4
#define GUARD_VAL 0x2a
#line 14 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_asn1write.function"
void test_mbedtls_asn1_write_octet_string( data_t * str, data_t * asn1,
...
void test_mbedtls_asn1_write_octet_string_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], *( (uint32_t *) params[1] )};
    data_t data2 = {(uint8_t *) params[2], *( (uint32_t *) params[3] )};

    test_mbedtls_asn1_write_octet_string( &data0, &data2, *( (int *) params[4] ), *( (int *) params[5] ) );
}
#line 47 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_asn1write.function"
void test_mbedtls_asn1_write_ia5_string( char * str, data_t * asn1,
                                    int buf_len, int result )
{
    int ret;
    unsigned char buf[150];
...
void test_mbedtls_asn1_write_ia5_string_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], *( (uint32_t *) params[2] )};

    test_mbedtls_asn1_write_ia5_string( (char *) params[0], &data1, *( (int *) params[3] ), *( (int *) params[4] ) );
}
#if defined(MBEDTLS_ASN1PARSE_C)
#line 82 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_asn1write.function"
...
#line 133 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_asn1write.function"
...
void test_test_asn1_write_bitstrings_wrapper( void ** params )
{
    ...
    test_test_asn1_write_bitstrings( &data0, *( (int *) params[2] ), &data3, *( (int *) params[5] ), *( (int *) params[6] ) );
}
...
#if defined(MBEDTLS_ASN1_WRITE_C)
    test_mbedtls_asn1_write_octet_string_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */
...
#if defined(MBEDTLS_ASN1_WRITE_C)
    test_mbedtls_asn1_write_ia5_string_wrapper,
#else
    NULL,
#endif
/* Function Id: 2 */

#if defined(MBEDTLS_ASN1_WRITE_C) && defined(MBEDTLS_ASN1PARSE_C)
