 ...
 *      Test suite file     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_arc4.function
 *      Test suite data     : /home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_arc4.data
 *
 *
...
#line 2 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_arc4.function"
#include "mbedtls/arc4.h"
#line 11 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_arc4.function"
void test_mbedtls_arc4_crypt( data_t * src_str, data_t * key_str,
...
void test_mbedtls_arc4_crypt_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], *( (uint32_t *) params[1] )};
    data_t data2 = {(uint8_t *) params[2], *( (uint32_t *) params[3] )};
    data_t data4 = {(uint8_t *) params[4], *( (uint32_t *) params[5] )};

    test_mbedtls_arc4_crypt( &data0, &data2, &data4 );
}
#if defined(MBEDTLS_SELF_TEST)
#line 32 "/home/ubuntu/work/git-repos/aws-iot-device-sdk-embedded-C/external_libs/mbedTLS/crypto/tests/suites/test_suite_arc4.function"
void test_arc4_selftest(  )
{
...
void test_arc4_selftest_wrapper( void ** params )
{
    (void)params;
...
#if defined(MBEDTLS_ARC4_C)
    test_mbedtls_arc4_crypt_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */

#if defined(MBEDTLS_ARC4_C) && defined(MBEDTLS_SELF_TEST)
    test_arc4_selftest_wrapper,
#else
    NULL,
#endif
...
int execute_tests( int argc , const char ** argv )
{
    ...
    const char *default_filename = "./test_suite_arc4.datax";
